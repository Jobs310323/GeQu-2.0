...
export function Habits({ habits, setHabits }: HabitsProps) {
    ...
    return (
        <div className="max-w-3xl">
            <PageHeader page="habits" title={t('track:habits.title')}
                subtitle={t('track:habits.subtitle')} />
            ...
            <div className="glass-card p-4 rounded-2xl mb-6 flex gap-3">
                <input type="text" value={name} onChange={e => setName(e.target.value)} onKeyDown={e => e.key === 'Enter' && addHabit()}
                    placeholder={t('track:habits.newPlaceholder')}
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-400 flex items-center gap-1">
                                            ...
                                            {t('track:habits.streak', { count: streak })}
                                        </div>
                                    </div>
                                </div>
