    ...
    return (
        <section aria-labelledby="today-insight" className="mt-6">
            <div className="flex items-baseline justify-between mb-3">
                <h2 id="today-insight" className="text-sm font-medium text-[var(--text-muted)]">
                    О тебе
                </h2>
                {observation && (
                    <Link to="/insights/progress" className="text-xs text-cyan-400 hover:underline">
                        Больше выводов
                    </Link>
                )}
            </div>
            ...
            {observation ? (
                <div className="glass-card rounded-2xl p-4">
                    <div className="flex gap-3">
                        ...
                        <p className="text-sm leading-relaxed flex-1">{observation.text}</p>
                    </div>
                ...
                <div className="glass-card rounded-2xl p-4">
                    ...
                    <Link
                        to="/today/checkin"
                        className="inline-flex items-center gap-1.5 text-xs text-cyan-400 hover:underline mt-2"
                    >
