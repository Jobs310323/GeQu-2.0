...
const paths: Record<string, string> = {
    ...
    brain: 'M9.5 3A2.5 2.5 0 0 0 7 5.5a2.5 2.5 0 0 0-1.5 4.5A2.5 2.5 0 0 0 6 14.8 2.5 2.5 0 0 0 9.5 18a2 2 0 0 0 2.5-2V5a2 2 0 0 0-2.5-2zM14.5 3A2.5 2.5 0 0 1 17 5.5a2.5 2.5 0 0 1 1.5 4.5 2.5 2.5 0 0 1 .5 4.8A2.5 2.5 0 0 1 14.5 18a2 2 0 0 1-2.5-2V5a2 2 0 0 1 2.5-2z',
};
